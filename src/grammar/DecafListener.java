...
public interface DecafListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link DecafParser#mainDeclaration}.
	 * @param ctx the parse tree
	 */
	void enterMainDeclaration(DecafParser.MainDeclarationContext ctx);
	/**
	 * Exit a parse tree produced by {@link DecafParser#mainDeclaration}.
	 * @param ctx the parse tree
	 */
	void exitMainDeclaration(DecafParser.MainDeclarationContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterSingleValue(DecafParser.SingleValueContext ctx);
	/**
	 * Exit a parse tree produced by the {@code SingleValue}
	 * labeled alternative in {@link DecafParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitSingleValue(DecafParser.SingleValueContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterEqExpr(DecafParser.EqExprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code EqExpr}
	 * labeled alternative in {@link DecafParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitEqExpr(DecafParser.EqExprContext ctx);
	/**
