...
public interface DecafVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code SingleVal}
	 * labeled alternative in {@link DecafParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSingleVal(DecafParser.SingleValContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code EpExpr}
	 * labeled alternative in {@link DecafParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitEpExpr(DecafParser.EpExprContext ctx);
	/**
